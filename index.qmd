...
The problem with the data is: The variable "Salary" has an entity that is recorded with a $ sing and a comma which makes it a "String" value.
...
```{python}
# This python code generates the 
